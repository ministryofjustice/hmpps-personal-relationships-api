  ...
  inner class PrisonerContactRestrictionEntitySyncTests {
    ...
    fun `should create and then update a prisoner contact restriction`() {
      ...
      stubEvents.assertHasEvent(
        ...
        additionalInfo = PrisonerContactRestrictionInfo(prisonerContactRestrictionId = updatedPrisonerContactRestriction.prisonerContactRestrictionId, prisonerContactId = prisonerContactRestriction.prisonerContactId, Source.NOMIS, "UpdatedUser", "BXI"),
    ...
    fun `should delete an existing prisoner contact restriction`() {
      ...
      stubEvents.assertHasEvent(
        ...
        additionalInfo = PrisonerContactRestrictionInfo(prisonerContactRestrictionId = prisonerContactRestriction.prisonerContactRestrictionId, prisonerContactId = prisonerContactRestriction.prisonerContactId, Source.NOMIS, "SYS", null),
        personReference = PersonReference(dpsContactId = prisonerContactRestriction.contactId, nomsNumber = prisonerContactRestriction.prisonerNumber),
      )
