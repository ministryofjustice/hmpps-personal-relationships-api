...
class SyncAdminIntegrationTest : PostgresIntegrationTestBase() {
  ...
  private fun assertCustomPrisonerContactDeletedEvent(contactId: Long, prisonerContactId: Long, prisonerNumber: String, source: Source, user: User) {
    verify(telemetryContactCustomEventService, times(1)).trackDeletePrisonerContactEvent(contactId, prisonerContactId, prisonerNumber, null, null, null, source, user)
