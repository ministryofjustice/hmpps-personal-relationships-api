...
import uk.gov.justice.digital.hmpps.personalrelationships.helpers.createContactAddressRequest
import uk.gov.justice.digital.hmpps.personalrelationships.helpers.patchContactAddressRequest
import uk.gov.justice.digital.hmpps.personalrelationships.helpers.updateContactAddressRequest
...
class ContactAddressFacadeTest {
  ...
  private val facade = ContactAddressFacade(addressService, eventsService, telemetryContactCustomEventService)
