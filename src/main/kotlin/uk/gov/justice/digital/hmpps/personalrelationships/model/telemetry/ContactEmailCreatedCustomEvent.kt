...
class ContactEmailCreatedCustomEvent(
  val contactEmailDetails: ContactEmailDetails,
  val eventSource: Source,
  val eventUser: User,
  ): CustomTelemetryEvent(telemetryCustomEventType = CONTACT_EMAIL_CREATED_EVENT, source = eventSource.name, user = eventUser) {
