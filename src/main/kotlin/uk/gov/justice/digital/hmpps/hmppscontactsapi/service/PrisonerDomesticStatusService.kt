...
class PrisonerDomesticStatusService(
  ...
  fun getDomesticStatus(prisonerNumber: String): PrisonerDomesticStatusResponse = prisonerDomesticStatusRepository.findByPrisonerNumberAndActive(prisonerNumber, true)
