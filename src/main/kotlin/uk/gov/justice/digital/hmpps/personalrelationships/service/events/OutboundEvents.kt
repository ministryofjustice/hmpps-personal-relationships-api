...
data class PrisonerContactRestrictionInfo(val prisonerContactRestrictionId: Long, val prisonerContactId: Long, override val source: Source = Source.DPS, override val username: String, override val activeCaseLoadId: String?) : AdditionalInformation(source, username, activeCaseLoadId)
