...
class ContactAddressCreatedCustomEvent(
  val contactAddressDetails: ContactAddressDetails,
  val eventSource: Source,
  val eventUser: User,
  ): CustomTelemetryEvent(telemetryCustomEventType = CONTACT_ADDRESS_CREATED_EVENT, source = eventSource.name, user = eventUser) {
