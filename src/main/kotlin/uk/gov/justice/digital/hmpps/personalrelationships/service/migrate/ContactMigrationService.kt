...
import uk.gov.justice.digital.hmpps.personalrelationships.model.response.migrate.AddressAndPhones
import uk.gov.justice.digital.hmpps.personalrelationships.model.response.migrate.ContactsAndRestrictions
import uk.gov.justice.digital.hmpps.personalrelationships.model.response.migrate.ElementType
import uk.gov.justice.digital.hmpps.personalrelationships.model.response.migrate.IdPair
import uk.gov.justice.digital.hmpps.personalrelationships.model.response.migrate.MigrateContactResponse
    ...
    Pair(
      ...
      prisonerContactRepository.save(
        PrisonerContactEntity(
          ...
          // with creating a contact via migration, always set approvedBy and approvedTime
          it.approvedBy = relationship.createUsername ?: "MIGRATION"
